        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerId = table.Column<string>(maxLength: 70, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    CreatorId = table.Column<string>(maxLength: 70, nullable: false),
                    RepositoryId = table.Column<string>(maxLength: 70, nullable: false)
                },
                constraints: table =>
                {
