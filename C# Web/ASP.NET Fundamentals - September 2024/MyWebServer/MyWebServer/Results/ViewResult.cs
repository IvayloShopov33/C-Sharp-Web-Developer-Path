...
namespace MyWebServer.Results
{
    public class ViewResult : ActionResult
    {
        ...
        public ViewResult(HttpResponse response, IViewEngine viewEngine, string viewName, string controllerName, object model, string userId)
            : base(response)
        {
        ...
        private (string, bool) FindView(string viewName)
        {
            ...
            {
                viewPath = Path.GetFullPath($"./Views/" + viewName.TrimStart('/') + $".{fileExtension}");
