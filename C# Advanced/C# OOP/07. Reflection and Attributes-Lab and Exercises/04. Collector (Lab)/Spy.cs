...
namespace Stealer
{
    public class Spy
    {
        ...
        public string CollectGettersAndSetters(string className)
        {
            ...
            Type typeOfInvestigatedClass = Type.GetType(className);
            var getters = typeOfInvestigatedClass.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).Where(x => x.Name.StartsWith("get"));
            var setters = typeOfInvestigatedClass.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic).Where(x => x.Name.StartsWith("set"));
