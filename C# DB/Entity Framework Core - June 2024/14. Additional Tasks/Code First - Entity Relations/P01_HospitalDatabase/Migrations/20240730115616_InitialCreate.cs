    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Ivan Spasov", "Rheumatologist" });

            migrationBuilder.InsertData(
                table: "Medicaments",
                columns: new[] { "MedicamentId", "Name" },
                values: new object[] { 1, "Nonsteroidal anti-inflammatory drug" });

            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "PatientId", "Address", "Email", "FirstName", "HasInsurance", "LastName" },
                values: new object[] { 1, "София, Витошка 1", "miro_kosta@mail.bg", "Мирослав", true, "Костакараколев" });

            migrationBuilder.InsertData(
                table: "Diagnoses",
                columns: new[] { "DiagnoseId", "Comments", "Name", "PatientId" },
                values: new object[] { 1, "Arthritis is inflammation of muscles and joints.", "Arthritis", 1 });
            ...
            migrationBuilder.InsertData(
                table: "Visitations",
                columns: new[] { "VisitationId", "Comments", "Date", "DoctorId", "PatientId" },
                values: new object[] { 1, "The situation is stable, but there is room for improvement", new DateTime(2024, 7, 30, 11, 56, 15, 814, DateTimeKind.Utc).AddTicks(9101), 1, 1 });
