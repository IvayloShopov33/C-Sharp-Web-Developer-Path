...
public partial class SoftUni1Context : DbContext
{
    public SoftUni1Context()
    {
    }

    public SoftUni1Context(DbContextOptions<SoftUni1Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<EmployeesNewTable> EmployeesNewTables { get; set; }
    ...
    public virtual DbSet<VEmployeesByYear> VEmployeesByYears { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.;Integrated Security=true;Database=SoftUni1;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeesNewTable>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("EmployeesNewTable");
        ...
        modelBuilder.Entity<VEmployeesByYear>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("v_EmployeesByYear");
